...
<div class="container">
      ...
      <?php 
          ...
          foreach ($listaRetiro as $retiro) {
            ...
            <h4 class="d-flex justify-content-between align-items-center mb-3">
            <span class="text-muted">Seleccionar Mes</span>
            <span class="badge badge-secondary badge-pill">1</span>
          </h4>
          <form action='controlador.php' method='post'>
          <input type='hidden' name='id' value='<?php echo $cliente["id"] ?>'>
            <div class="input-group">
              <input type="month" class="form-control" id="mes" name="mes" value="<?php echo date("m") ?>" placeholder="Selecione Mes">
              <div class="input-group-append">
              <input type='submit' class="btn btn-secondary"  value='Reporte' name='fecha'>
              </div>
            </div>
          </form>
        </div>
